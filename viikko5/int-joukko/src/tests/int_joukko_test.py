...
class TestIntJoukko(unittest.TestCase):
    ...
    def toimii_kasvatuksen_jalkeen(self, joukko):
        ...
        self.assertEqual(joukko.alkioita_taulussa(), 14)
        self.assertTrue(joukko.kuuluu_jonoon(11))
        joukko.poista(11)
        self.assertFalse(joukko.kuuluu_jonoon(11))
        self.assertEqual(joukko.alkioita_taulussa(), 13)

    def test_lukuja_lisatty_maara(self):
        self.joukko.lisaa_luku(4)
        self.assertEqual(self.joukko.alkioita_taulussa(), 3)

    def test_sama_luku_menee_joukkoon_vaan_kerran(self):
        self.joukko.lisaa_luku(10)
        self.joukko.lisaa_luku(3)
        self.assertEqual(self.joukko.alkioita_taulussa(), 2)

    def test_vain_lisatyt_luvut_loytyvat(self):
        self.assertTrue(self.joukko.kuuluu_jonoon(10))
        self.assertFalse(self.joukko.kuuluu_jonoon(5))
        self.assertTrue(self.joukko.kuuluu_jonoon(3))

    def test_poistettu_ei_ole_enaa_joukossa(self):
        self.joukko.poista(3)
        self.assertFalse(self.joukko.kuuluu_jonoon(3))
        self.assertEqual(self.joukko.alkioita_taulussa(), 1)
